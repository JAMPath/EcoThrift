...
//        }
        ...
        self.ref.child("Owners").setValue("10")
        for i in 1...10 {
            let id = Int.random(in: 1...9999)
            ...
            self.ref.child("Owners").child("Owner_\(id)").setValue(10)
            self.ref.child("Owners").child("Owner_\(id)").child("Followers").setValue("\(followers)")
            self.ref.child("Owners").child("Owner_\(id)").child("Following").setValue("\(following)")
            self.ref.child("Owners").child("Owner_\(id)").child("Sales").setValue("\(sales)")
        }
